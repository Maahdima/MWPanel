...
type Interface struct {
	...
	LastTx            int64   `gorm:"type:bigint;not null;default:0"`
	LastRx            int64   `gorm:"type:bigint;not null;default:0"`
	DailyTrafficReady bool    `gorm:"type:boolean;not null;default:false"`
